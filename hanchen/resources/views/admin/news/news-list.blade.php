...
@section('content')
	...
	<div class="cl pd-5 bg-1 bk-gray"> <span class="l"> <a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" href="{{ url('admin/news/create') }}"><i class="Hui-iconfont">&#xe600;</i> 添加新闻</a> </span> <span class="r">共有数据：<strong>5</strong> 条</span> </div>
	...
	layer.confirm('角色删除须谨慎，确认要删除吗？',function(index){
		$.ajax({
			...
			beforeSend: function(request) {
				request.setRequestHeader("_token",'{{ csrf_token() }}');
			},
