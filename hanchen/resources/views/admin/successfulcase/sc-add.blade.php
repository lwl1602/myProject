...
@section('content')
	...
	@endif
	<form action="{{ url('admin/sc') }}" method="post" class="form form-horizontal" id="form-admin-role-add" enctype="multipart/form-data">
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>案例描述：</label>
			<div class="formControls col-xs-8 col-sm-9">
